/**
 * Team Alpha - Apply Recurring Appointments Migration
 * Applies the recurring_appointments table to all tenant schemas
 */
...
async function applyMigration() {
  ...
  try {
    console.log('\n🔄 Applying Recurring Appointments Migration');
    console.log('='.repeat(60));

    // Read migration file
    const migrationPath = path.join(__dirname, '../migrations/1731672000000_create_recurring_appointments.sql');
