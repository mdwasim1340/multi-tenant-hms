...
import billingAdjustmentsRouter from './routes/billing-adjustments';
import taxConfigurationsRouter from './routes/tax-configurations';
import billingReportsRouter from './routes/billing-reports';
import billingIntegrationRouter from './routes/billing-integration';
import billingJobsRouter from './routes/billing-jobs';
import balanceReportsRouter from './routes/balance-reports';
...
app.use('/api/billing-adjustments', billingAdjustmentsRouter);
app.use('/api/tax-configurations', taxConfigurationsRouter);
app.use('/api/billing/reports', billingReportsRouter);
app.use('/api/billing/integration', billingIntegrationRouter);
app.use('/api/billing/jobs', billingJobsRouter);
app.use('/api/balance-reports', balanceReportsRouter);
