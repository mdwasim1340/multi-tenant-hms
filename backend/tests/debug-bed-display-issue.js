...
// Test credentials - using actual aajmin user
...
async function debugBedDisplayIssue() {
  ...
  try {
    ...
    const firstRequest = await axios.get(`${API_BASE}/api/bed-management/categories`, { headers });
    await new Promise(resolve => setTimeout(resolve, 1000)); // Wait 1 second
    const secondRequest = await axios.get(`${API_BASE}/api/bed-management/categories`, { headers });
