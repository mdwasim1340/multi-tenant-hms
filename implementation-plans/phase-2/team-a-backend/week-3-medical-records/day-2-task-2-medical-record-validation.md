# Week 3, Day 2, Task 2: Zod Validation Schemas

## 🎯 Task Objective
Create Zod validation schemas for medical records with business rules.

## ⏱️ Estimated Time: 2 hours

## 📝 Step 1: Create Validation Schemas

Create file: `backend/src/validation/medical-record.validation.ts`
...
```bash
git add src/validation/medical-record.validation.ts
git commit -m "feat(medical-records): Add Zod validation schemas"
```
