# Week 3, Day 2, Task 3: Medical Record Service Layer

## 🎯 Task Objective
Create MedicalRecordService with CRUD operations and business logic.

## ⏱️ Estimated Time: 2 hours

## 📝 Step 1: Create Medical Record Service

Create file: `backend/src/services/medical-record.service.ts`
...
export class MedicalRecordService {
  ...
  async createMedicalRecord(
    ...
    try {
      ...
      return await this.getMedicalRecordById(result.rows[0].id, tenantId);
  ...
  async updateMedicalRecord(
    ...
    try {
      ...
      return await this.getMedicalRecordById(id, tenantId);
...
```bash
git add src/services/medical-record.service.ts
git commit -m "feat(medical-records): Add medical record service layer"
```
